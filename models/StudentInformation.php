...
EOL;
    ...
    /**
     *
     * @param $requirement_certificate
     * @return array
     */
    public function saveStudentCeritificateRequirement($requirement_certificate)
    {
        $filesSaved = [];
        foreach ($requirement_certificate as $currentCertificateRequirement) {
            /**
             * @var $currentCertificateRequirement UploadedFile
             */
